...
public class ConnectionUtils {
    ...
    public static java.sql.Connection getConnection() {
        ...
        try {
            ...
            String serveName = "modelpizzaria.mysql.uhserver.com"; // Caminho do servidor do BD
            String mydatabase = "modelpizzaria"; // Nome do banco de dados
            String url = "jdbc:mysql://" + serveName + "/" + mydatabase;
            String username = "modelpizza01"; // Nome de usuario
            String password = "br@sil1001"; // Senha de acesso
